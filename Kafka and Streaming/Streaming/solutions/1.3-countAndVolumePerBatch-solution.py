...
volumePerType = orders.map(lambda o: ("BUYVOL", o['amount'] * o['price']) if o['buy'] else ("SELLVOL", o['amount'] * o['price'])).reduceByKey(add)

finalStream = numPerType.union(volumePerType)
finalStream.pprint()
